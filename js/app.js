(() => {
    ...
    $((function() {
        ...
        $(".shop__slider").slick({
            slidesToShow: 1,
            slidesToScroll: 1,
            prevArrow: '<img class="slider-arrows slider-arrows__left" src="img/icons/arrow-left.svg" alt="pic"></img>',
            nextArrow: '<img class="slider-arrows slider-arrows__right" src="img/icons/arrow-right.svg" alt="pic"></img>'
        });
        jQuery('<div class="quantity-nav"><div class="quantity-button quantity-up"><img src="img/sleep/plus.svg" alt="pic-logo"></div><div class="quantity-button quantity-down"><img src="img/sleep/minus.svg" alt="pic-logo"></div></div>').insertAfter(".quantity input");
        ...
        $(".quantity-button").on("click", (function() {
            let summa = $(".nights").val() * $(".summa").data("nights") + ($(".guests").val() - 1) * $(".summa").data("guests");
            $(".summa").html("$" + summa);
        }));
        let summa = $(".nights").val() * $(".summa").data("nights") + ($(".guests").val() - 1) * $(".summa").data("guests");
        $(".summa").html("$" + summa);
        $(".wrapper-box__tip").on("click", (function() {
